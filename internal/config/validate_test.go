...
func TestValidateAcceptsKnownSettings(t *testing.T) {
	valid := []string{
		...
		// An include may also be written in object form to opt into the Docker sidecar mirror.
		`{"files":{"include":{"~/.m2/settings.xml":{"path":"~/.m2/settings.xml","docker":true}}}}`,
		`{"files":{"include":{"~/.m2/settings.xml":{"path":"~/.m2/settings.xml"}}}}`,
		`{"profiles":{"build":{"files":{"include":{"~/.m2/settings.xml":{"path":"~/.m2/settings.xml","docker":true}}}}}}`,
...
func TestValidateRejectsUnknownAndMalformedSettings(t *testing.T) {
	invalid := map[string]string{
		...
		"include object without path": `{"files":{"include":{"~/.npmrc":{"docker":true}}}}`,
		"include object unknown key":  `{"files":{"include":{"~/.npmrc":{"path":"~/.npmrc","readwrite":true}}}}`,
		"include docker not a bool":   `{"files":{"include":{"~/.npmrc":{"path":"~/.npmrc","docker":"yes"}}}}`,
		"include empty path":          `{"files":{"include":{"~/.npmrc":{"path":""}}}}`,
		"include empty string":        `{"files":{"include":{"~/.npmrc":""}}}`,
	}
